...
public class CaptureActivity extends Activity implements Callback {
	...
	private int TAKE_PHOTO_REQUEST_CODE=0x2135;
	...
	private String tag ="org.benmobile.benh5";
...
//		Toast.makeText(getApplicationContext(), result, Toast.LENGTH_SHORT).show();
	...
	private void testApi(String result) {
		//将扫描结果推送到中间件消息池中
		QuestProtocolManager.getInstance().QusetProtocolPushMsgData(tag,result,requestcode);
		this.finish();
//        val hostInterface = Protocol { "发送消息测试" }
//        //发送数据到中间件，默认支持观察者
//        ComponentRegister.getInstance().setComponent(tag, requestcode.toString(), hostInterface)
	}
